...
?>
     <div class="row">  
        ...
        <div class="box"><?= Html::a('Xóa', Url::base().'/index.php?r=img/delete&&id='.$img['id_img'].'&&typedelete=myalbum&&id_album='.$id_album, [
...
<?php }?>
    ...
    <div class="row">
        <?= Html::a('Xem Album', Url::base().'/index.php?r=album/albumview&id='.$id_album, ['class' => 'btn btn-success']) ?>
    </div>
