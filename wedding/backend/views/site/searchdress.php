...
<div class = "dress-search">
		...
		<img src='<?php echo $img['avatar'] ?>' /></a>
	            <ul class='mask'>
	                ...
	                <p><a href='<?php echo 'index.php?r=dress/viewimg&&id='.$img['id_dress'] ?>'  title='Ngoại Cảnh Phú Mỹ Hưng'><?php echo $img['name_dress'] ?></a></p>
                        <p><a href='<?php echo 'index.php?r=dress/viewimg&&id='.$img['id_dress'] ?>'  title='Ngoại Cảnh Phú Mỹ Hưng'><?php echo number_format($img['rate_hire']) ?>VND/Ngày</a></p>
                    </ul>
    ...
    ?>
        <h2>Không tìm thấy áo cưới nào phụ hợp</h2>
    <?php } ?>   
    </div>
</div>
